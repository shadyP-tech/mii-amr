...
def _qr_visuals(station_id: str) -> str:
    ...
    module = 0.38 / 29.0
    visuals = [
        _box_visual("qr_white_panel", _pose(0.023, 0.0, 1.18), (0.004, 0.38, 0.38), WHITE)
    ]
...
def _station_model(station: Mapping[str, object]) -> str:
    ...
    visuals = [
        _box_visual("base_center", _pose(0, 0, 0.025), (0.30, 0.30, 0.05), GREEN),
        _box_visual("neck", _pose(0, 0, 0.105), (0.16, 0.16, 0.16), GREEN_DARK),
        _box_visual("stem", _pose(0, 0, 0.53), (0.065, 0.065, 0.82), GREEN),
        _box_visual("head_board", _pose(0, 0, 1.18), (0.04, 0.50, 0.50), GREEN),
    ]
    collisions = [
        _box_collision("base_center", _pose(0, 0, 0.025), (0.30, 0.30, 0.05)),
        _box_collision("stem", _pose(0, 0, 0.53), (0.065, 0.065, 0.82)),
        _box_collision("head_board", _pose(0, 0, 1.18), (0.04, 0.50, 0.50)),
    ]
    for index, arm_yaw in enumerate((0.785398, 2.356194, 3.926991, 5.497787)):
        arm_pose = _pose(0.0, 0.0, 0.025, arm_yaw)
        arm_size = (0.68, 0.115, 0.05)
