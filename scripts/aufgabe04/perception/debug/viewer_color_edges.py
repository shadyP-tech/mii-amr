"""HSV support for the debug viewer's measured Canny borders."""
...
# Viewer-only palette for the five physical stands. September 11–17 camera
...
def color_edge_support(cv2, numpy, frame, *, color="all", ranges=None):
    ...
    """
    if ranges is None:
        ranges = tuple(item for item in VIEWER_STAND_PALETTE
