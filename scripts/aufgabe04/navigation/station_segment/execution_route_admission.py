...
def admit_execution_route(
    *,
    ...
    emit_event(
        ...
        route_csv=str(Path(args.route_csv).resolve()),
        diagnostics_json=str(Path(args.diagnostics_json).resolve()),
        authoritative_route_csv=str(Path(route_csv_path).resolve()),
        authoritative_diagnostics_json=str(Path(diagnostics_json_path).resolve()),
        route_manifest=str(args.route_manifest or ""),
