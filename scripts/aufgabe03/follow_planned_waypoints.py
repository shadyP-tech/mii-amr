...
POST_REPLAN_ESCAPE_ROUTE_BLOCKED_COUNT_THRESHOLD = (
    post_replan_recovery.POST_REPLAN_ESCAPE_ROUTE_BLOCKED_COUNT_THRESHOLD
)
POST_REPLAN_ESCAPE_ROUTE_BLOCKED_PERSISTENCE_SCANS = (
    post_replan_recovery.POST_REPLAN_ESCAPE_ROUTE_BLOCKED_PERSISTENCE_SCANS
)
POST_REPLAN_ESCAPE_ROUTE_BLOCKED_MARGIN_M = (
    post_replan_recovery.POST_REPLAN_ESCAPE_ROUTE_BLOCKED_MARGIN_M
)
