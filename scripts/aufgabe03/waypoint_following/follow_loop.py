...
def ensure_follow_runtime_state(node, build_command_smoother):
    ...
    _setdefault_attr(node, "last_odom", None)
    _setdefault_attr(node, "last_odom_pose", None)
    _setdefault_attr(node, "last_odom_received_sec", None)
    ...
    _setdefault_attr(node, "last_post_replan_recovery_escape_odom_source", "")
    _setdefault_attr(node, "last_post_replan_recovery_escape_odom_source_fallback_reason", "")
    _setdefault_attr(node, "last_post_replan_recovery_escape_direct_odom_distance_m", None)
    _setdefault_attr(node, "last_post_replan_recovery_escape_tf_odom_distance_m", None)
    _setdefault_attr(node, "last_post_replan_recovery_escape_direct_odom_age_sec", None)
    _setdefault_attr(node, "last_post_replan_recovery_escape_direct_odom_stamp_delta_sec", None)
    _setdefault_attr(node, "last_post_replan_recovery_escape_tf_odom_stamp_delta_sec", None)
    _setdefault_attr(node, "last_post_replan_recovery_escape_direct_odom_frame_id", "")
    _setdefault_attr(node, "last_post_replan_recovery_escape_direct_odom_child_frame_id", "")
    _setdefault_attr(node, "last_post_replan_recovery_escape_odom_disagreement", "")
