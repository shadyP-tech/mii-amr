...
DEFAULT_FOLLOWER_SCAN_HALF_ANGLE_DEG = 35.0

DEFAULT_FOLLOWER_HARD_STOP_RANGE_M = 0.16

DEFAULT_FOLLOWER_MIN_SCAN_RANGE_M = 0.40
...
DEFAULT_ARENA_ACTIVE_TEMPORARY_MAP_TOPIC = "/mii_amr/arena_active/temporary_map"

DEFAULT_ARENA_ACTIVE_TEMPORARY_PLANNING_MAP_TOPIC = (
    "/mii_amr/arena_active/temporary_map_planning"
)

DEFAULT_ARENA_ACTIVE_TEMPORARY_MAP_FRAME = "odom"

DEFAULT_ARENA_ACTIVE_TEMPORARY_MAP_PUBLISH_PERIOD_SEC = 1.0

DEFAULT_ARENA_ACTIVE_EXPLORE_PATH_TOPIC = "/mii_amr/arena_active/explore_path"

DEFAULT_ARENA_ACTIVE_EXPLORE_CANDIDATE_MARKER_TOPIC = (
    "/mii_amr/arena_active/explore_candidates"
)
